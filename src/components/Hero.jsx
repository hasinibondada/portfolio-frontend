    ...
    <section className="relative min-h-[60vh] flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center animate-fade-in">
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap mt-4">
          <a href="/HASINITCS.pdf" download className="px-5 py-2.5 border border-gray-700 hover:border-blue-500/50 text-gray-300 hover:text-white rounded-lg font-medium transition-all text-sm flex items-center gap-2">
